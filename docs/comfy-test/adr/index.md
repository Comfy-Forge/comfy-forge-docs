...
| [0005](0005-pinned-torch-random-python.md) | Pinned torch, random Python | **Superseded.** The triple is now derived from the wheel index, not tabulated; Python defaults to a fixed 3.13. |
...
| [0012](0012-level-flag-swaps-terminals.md) | ~~`--level` swaps terminal levels~~ **(superseded)** | The flag is deleted; `[test] levels` alone decides what a run does. |
