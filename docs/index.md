...
| [comfy-test](https://github.com/PozzettiAndrea/comfy-test) | Installation testing infrastructure: installs a nodepack the way a user would, on a real platform matrix (Linux/Windows/macOS, CPU/CUDA, portable/desktop), and publishes results. | [Overview](comfy-test/index.md) |
