...
| [0035](0035-duck-typed-model-proxy.md) | The model proxy is a duck-type | 18 declared members instead of ~120 inherited; unknown access raises naming the attribute. **Deprecated by [0038](0038-the-memory-floor.md):** host-driven reclaim dropped; a default-off observer replaces it. |
