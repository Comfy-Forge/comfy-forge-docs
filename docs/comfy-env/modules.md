...
| `environment/setup.py` | 69 | The prestartup hook `setup_env()`: faulthandler, workspace banner, libomp dedupe. (The parent-side shareable-pool hook was removed in 0.4.22; the `base_directory` fill-in in 0.4.27.) |
